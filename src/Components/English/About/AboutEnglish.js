...
const AboutEnglish = () => {
  return (
    <section className="p-3 p-sm-5 common-bg">
        <p className="title mb-3 mb-sm-4">Vision and Mission of Don Bosco School of Merit</p>
        <div className="row">
           <div className="col-lg-6">
           <img src="/Images/English/About/English.jpg" alt="No-Image" className="about-english-img w-100 rounded-3"/>
           </div>
           <div className="col-lg-6">
           <img src="/Images/English/About/English2.jpg" alt="No-Image" className="about-english-img w-100 d-none d-lg-block rounded-3"/>
           </div>
